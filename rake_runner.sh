...
/usr/local/rvm/wrappers/ruby-2.7.0@my_website/rake share_file:clean_up_file_senders
/usr/local/rvm/wrappers/ruby-2.7.0@my_website/rake share_file:delete_alert_sender
